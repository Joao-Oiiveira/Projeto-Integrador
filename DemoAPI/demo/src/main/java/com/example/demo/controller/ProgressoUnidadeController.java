...
import com.example.demo.repository.ProgressoUnidadeRepository;
...
@RequestMapping(value="/apiProgunidade")
//Define a url que quando for
//requisitada chamará os
//métodos da classe: qualquer
//ação desse controller deve vir
//depois de /apiAluno
public class ProgressoUnidadeController {

    @Autowired
    ProgressoUnidadeRepository progressoUnidadeRepository;
}
